...
public class CommandToGroup implements ICommand, IUndoRedo {
	
	private ShapeLists myShapeList;
	private List<IShape> myUndoRedoList = new ArrayList<>();
	Group group = new Group ();
	public CommandToGroup(ShapeLists shapeList)
	{
	...
	public void run() throws IOException {
		System.out.println("Running ------------->>> GROUP MODE");
		...
		{
			IShape selectedShape = shape;
			myUndoRedoList.add(selectedShape);
			group.add(selectedShape);
		
		}
		myShapeList.reDrawShapes();
		CommandHistory.add(this);
		System.out.println("The Shapes are GROUPED");		
	}
